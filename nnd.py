...
for j in range(n_mass_sample):
    ...
    #saving data
    name_nnd = 'NND'+'-'+name+'-'+'z'+str(redshift)+'-sample'+str(m)+'-num_subbox'+str(num_sub_boxes)+'.txt'
    name_J = 'J-function'+'-'+name+'-'+'z'+str(redshift)+'-sample'+str(m)+'-num_subbox'+str(num_sub_boxes)+'.txt'
